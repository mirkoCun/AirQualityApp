...
foreach($cities as $city) {
    ...
    // AIR
    $urlAir = "https://air-quality-api.open-meteo.com/v1/air-quality?latitude=$lat&longitude=$lon&hourly=pm10,pm2_5,carbon_monoxide,nitrogen_dioxide,ozone,nitrogen_monoxide,ammonia,european_aqi&past_days=7&timezone=Europe%2FRome";
    
    // WEATHER
    $urlWeather = "https://api.open-meteo.com/v1/forecast?latitude=$lat&longitude=$lon&hourly=temperature_2m,relative_humidity_2m,precipitation,precipitation_probability,wind_speed_10m,apparent_temperature,weather_code&past_days=7&timezone=Europe%2FRome";
